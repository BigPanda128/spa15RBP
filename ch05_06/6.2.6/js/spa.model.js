...
spa.model = (function () {
  ...
  people = (function () {
    ...
    login = function ( name ) {
      // connect to our data source, wither fake or server based
      ...
      // listen for userupdate and when its called run complete login
      sio.on( 'userupdate', completeLogin );

      // provide the bakend with te dets for the new user
      sio.emit( 'adduser', {
